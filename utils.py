...
def preprocess_data_placement(df):
    df.drop(df.loc[df['Campus']=='MIT - WPU'].index, inplace=True)
    ...
    df['BackPapers1'] = df['BackPapers1'].fillna(value=0)
    df['P_BackPapers1'] = df['P_BackPapers1'].fillna(value=0)
    df['BackPapers2'] = df['BackPapers2'].fillna(value=0)
    df['P_BackPapers2'] = df['P_BackPapers2'].fillna(value=0)
    df['BackPapers3'] = df['BackPapers3'].fillna(value=0)
    df['P_BackPapers3'] = df['P_BackPapers3'].fillna(value=0)
    df['BackPapers4'] = df['BackPapers4'].fillna(value=0)
    df['P_BackPapers4'] = df['P_BackPapers4'].fillna(value=0)
    df['BackPapers5'] = df['BackPapers5'].fillna(value=0)
    df['P_BackPapers5'] = df['P_BackPapers5'].fillna(value=0)
    df['BackPapers6'] = df['BackPapers6'].fillna(value=0)
    df['P_BackPapers6'] = df['P_BackPapers6'].fillna(value=0)
    df['BackPapers7'] = df['BackPapers7'].fillna(value=0)
    df['P_BackPapers7'] = df['P_BackPapers7'].fillna(value=0)

    df['live_atkt'] = df['live_atkt'].fillna(value=0)
    df['dead_back_log'] = df['dead_back_log'].fillna(value=0)
